...
class SectionModel
{
    ...
    public function createSection(array $data): int
    {
        $stmt = $this->pdo->prepare('
            INSERT INTO sections (name, grade_level, room, max_students, school_year, description, is_active, created_by)
            VALUES (:name, :grade_level, :room, :max_students, :school_year, :description, 1, :created_by)
        ');
        $stmt->execute([
            'name' => $data['name'],
