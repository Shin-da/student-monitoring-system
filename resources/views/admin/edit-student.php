<div class="dashboard-header mb-4">
  <div class="d-flex justify-content-between align-items-center">
    <div>
      <h1 class="h3 fw-bold mb-1">Edit Student</h1>
      <p class="text-muted mb-0">Update student information</p>
    </div>
    <div>
      <a href="<?= \Helpers\Url::to('/admin/view-student?id=' . ($student['id'] ?? 0)) ?>" class="btn btn-outline-secondary btn-sm">
        <svg width="16" height="16" fill="currentColor">
          <use href="#icon-arrow-left"></use>
        </svg>
        <span class="d-none d-md-inline ms-1">Back to Student</span>
      </a>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-lg-8">
    <form method="post" action="<?= \Helpers\Url::to('/admin/update-student') ?>" id="editStudentForm" novalidate>
          ...
          <div class="col-md-4">
            <div class="form-floating">
              <input type="text" class="form-control" id="first_name" name="first_name" 
                     placeholder="Juan" value="<?= htmlspecialchars($student['first_name'] ?? '') ?>" required>
          ...
          <div class="col-md-4">
            <div class="form-floating">
              <input type="text" class="form-control" id="middle_name" name="middle_name" 
                     placeholder="Santos" value="<?= htmlspecialchars($student['middle_name'] ?? '') ?>">
          ...
          <div class="col-md-4">
            <div class="form-floating">
              <input type="text" class="form-control" id="last_name" name="last_name" 
                     placeholder="Dela Cruz" value="<?= htmlspecialchars($student['last_name'] ?? '') ?>" required>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <select class="form-select" id="enrollment_status" name="enrollment_status">
                <option value="enrolled" <?= ($student['enrollment_status'] ?? 'enrolled') === 'enrolled' ? 'selected' : '' ?>>Enrolled</option>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="school_year" name="school_year" 
                     placeholder="2025-2026" value="<?= htmlspecialchars($student['school_year'] ?? '2025-2026') ?>">
          ...
          <div class="col-12">
            <div class="form-floating">
              <input type="text" class="form-control" id="previous_school" name="previous_school" 
                     placeholder="Previous School Name" value="<?= htmlspecialchars($student['previous_school'] ?? '') ?>">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="email" class="form-control" id="email" name="email" 
                     placeholder="student@example.com" value="<?= htmlspecialchars($student['email'] ?? '') ?>" required>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="tel" class="form-control" id="contact_number" name="contact_number" 
                     placeholder="+63 912 345 6789" value="<?= htmlspecialchars($student['contact_number'] ?? '') ?>">
          ...
          <div class="col-12">
            <div class="form-floating">
              <textarea class="form-control" id="address" name="address" 
                        placeholder="Complete address" style="height: 100px"><?= htmlspecialchars($student['address'] ?? '') ?></textarea>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="guardian_name" name="guardian_name" 
                     placeholder="Guardian Full Name" value="<?= htmlspecialchars($student['guardian_name'] ?? '') ?>">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="tel" class="form-control" id="guardian_contact" name="guardian_contact" 
                     placeholder="+63 912 345 6789" value="<?= htmlspecialchars($student['guardian_contact'] ?? '') ?>">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <select class="form-select" id="guardian_relationship" name="guardian_relationship">
                ...
                <option value="grandfather" <?= ($student['guardian_relationship'] ?? '') === 'grandfather' ? 'selected' : '' ?>>Grandfather</option>
                <option value="grandmother" <?= ($student['guardian_relationship'] ?? '') === 'grandmother' ? 'selected' : '' ?>>Grandmother</option>
                <option value="uncle" <?= ($student['guardian_relationship'] ?? '') === 'uncle' ? 'selected' : '' ?>>Uncle</option>
                <option value="aunt" <?= ($student['guardian_relationship'] ?? '') === 'aunt' ? 'selected' : '' ?>>Aunt</option>
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" id="emergency_contact_name" name="emergency_contact_name" 
                     placeholder="Emergency Contact Name" value="<?= htmlspecialchars($student['emergency_contact_name'] ?? '') ?>">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="tel" class="form-control" id="emergency_contact_number" name="emergency_contact_number" 
                     placeholder="+63 912 345 6789" value="<?= htmlspecialchars($student['emergency_contact_number'] ?? '') ?>">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <select class="form-select" id="emergency_contact_relationship" name="emergency_contact_relationship">
                <option value="">Select Relationship</option>
                <option value="father" <?= ($student['emergency_contact_relationship'] ?? '') === 'father' ? 'selected' : '' ?>>Father</option>
                <option value="mother" <?= ($student['emergency_contact_relationship'] ?? '') === 'mother' ? 'selected' : '' ?>>Mother</option>
                <option value="grandfather" <?= ($student['emergency_contact_relationship'] ?? '') === 'grandfather' ? 'selected' : '' ?>>Grandfather</option>
                <option value="grandmother" <?= ($student['emergency_contact_relationship'] ?? '') === 'grandmother' ? 'selected' : '' ?>>Grandmother</option>
                <option value="uncle" <?= ($student['emergency_contact_relationship'] ?? '') === 'uncle' ? 'selected' : '' ?>>Uncle</option>
                <option value="aunt" <?= ($student['emergency_contact_relationship'] ?? '') === 'aunt' ? 'selected' : '' ?>>Aunt</option>
                <option value="guardian" <?= ($student['emergency_contact_relationship'] ?? '') === 'guardian' ? 'selected' : '' ?>>Guardian</option>
                <option value="other" <?= ($student['emergency_contact_relationship'] ?? '') === 'other' ? 'selected' : '' ?>>Other</option>
              </select>
          ...
          <div class="col-12">
            <div class="form-floating">
              <textarea class="form-control" id="medical_conditions" name="medical_conditions" 
                        placeholder="Any medical conditions or health concerns" style="height: 80px"><?= htmlspecialchars($student['medical_conditions'] ?? '') ?></textarea>
          ...
          <div class="col-12">
            <div class="form-floating">
              <textarea class="form-control" id="allergies" name="allergies" 
                        placeholder="Any known allergies" style="height: 80px"><?= htmlspecialchars($student['allergies'] ?? '') ?></textarea>
      ...
      <div class="surface p-4 mb-4">
        ...
        <div class="form-floating">
          <textarea class="form-control" id="notes" name="notes" 
                    placeholder="Any additional notes or comments" style="height: 100px"><?= htmlspecialchars($student['notes'] ?? '') ?></textarea>
