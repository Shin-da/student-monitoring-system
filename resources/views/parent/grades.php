...
<!-- Parent Grades Header -->
<div class="dashboard-header mb-4">
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div>
      <h1 class="h3 mb-1 text-primary">Child's Academic Performance</h1>
      <p class="text-muted mb-0">View your child's grades by quarter</p>
    </div>
...
<div class="surface p-5 text-center">
    ...
    <p class="text-muted mb-0">Your child's teacher hasn't posted any grades for this quarter yet.</p>
</div>
<?php else: ?>
...
<div class="surface p-4">
  ...
  <?php if (empty($quarterlyGrades)): ?>
    <div class="text-center py-5">
      ...
      <p class="text-muted small">Grades will appear here once your child's teachers have entered them.</p>
    </div>
  <?php else: ?>
